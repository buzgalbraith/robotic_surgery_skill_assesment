...
NUM_STATES = 2
RESOLUTION = 1
BATCH_SIZE = 3 ## was have tried 3,5,10
TOTAL_EPOCHS = 50 ## have tried 10, 100, 250,1000
ALPHA = 0.95 ## have tried 0.2 ,0,7, 0.85
AVG = True
LAMBDA = 0.0005 ## used to be 0.2
T = 100 ## have tried 10, 100, 250,1000"
...
if __name__ == "__main__":
    ...
    for epoch in tqdm.tqdm(range(TOTAL_EPOCHS)):
        ...
        self_supervised_loss_history.append(source_loss + ALPHA*target_loss)
